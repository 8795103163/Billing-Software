...
class Bill_App:
    def __init__(self,root):
        self.root=root
        self.root.title('Billing Project Made by Phool Chand Varun ,Using Python')
        self.root.geometry('1360x768+0+0')
        self.root.iconbitmap(r'img\phoolchand-modified.ico')
        ...
        #******billing software***************
        lbl_title=Label(self.root,text='BILLING SOFTWARE USING PYTHON BY PHOOLCHAND',font=('times new roman',30,'bold'),bg='white',fg='blue')
    ...
    def welcome(self):
        ...
        self.textarea.insert(END,'\tWelcome Phoolchand Varun Moll')
